...
var findConfig = require('../cli/config');
...
Base.prototype.testFilePath = function (test) {
  const showAsRelative =
    this.options.reporterOption.useRelativeFilePath || false;

  if (showAsRelative) {
    const configPath = findConfig();
    const relativeTestPath = path.relative(configPath, testPath);
